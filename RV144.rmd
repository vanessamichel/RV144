...
```
The bar chart shows us that about 40% of participants taking the vaccine contracted HIV, vs. 60% of participants who received the placebo contracted HIV.
...
The chi-square statistic is 3.9. The degrees of freedom reported to be 1. Since P=0.04, we reject the null hypothesis. The sample data appears to show strong evidence that there is a relationship between receiving the vaccine for HIV and whether or not one contracts the virus. 
